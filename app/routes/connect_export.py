...
# System prompts for Connect AI (GPT-5.3-chat with evidence scaffolding).
# These are reference copies — the gateway (infra/gateway/prompts.py) holds
# the authoritative versions used at runtime.
